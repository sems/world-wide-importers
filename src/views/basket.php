...
<div class="row">
        ...
        <div class="row">
            ...
            <div class='col-md-12'>
                <div class="row basket_product">
                    ...
                    <div class="col-md-5">
                        <h6><?php print($data['StockItemName']); ?>
                        </h6>
                        ...
                        <form method="post" action="f_handler.php?form_handler=f_delete_from_basket.php">
                            <input type="hidden" <?php print("name='" . $key . "'") ?>
                            <?php print("value='" . $basket[$key] . "'")?>>
                            <button class="btn btn-primary" type='submit' <?php print("value='" . $key . "'") ?>>Verwijder
                                product</button>
                        </form>
                    </div>
                    <div class="col-md-4">
    ...
    <div class="col-md-4">
        <p>Subtotaal: €<?php print(number_format($totalPrice, 2))?>
        </p>
