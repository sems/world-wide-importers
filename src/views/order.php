<div class="row">
    <div class="col-md-12">
        <h4>Order <?php print($_GET['id']);?>
        </h4>
        <div class="accordion" id="accordion_order">
            <div class="card">
                <div class="card-header" id="heading_payment">
                    <h5 class="mb-0">
                        <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapse_payment"
            ...
            <div class="card">
                <div class="card-header" id="heading_address">
                    <h5 class="mb-0">
                        <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapse_delivery"
                            aria-expanded="true" aria-controls="collapse_delivery">
                            Adressen
                        </button>
                    </h5>
                </div>
            ...
            <div class="card">
                <div class="card-header" id="heading_content">
                    <h5 class="mb-0">
                        <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapse_content"
                            aria-expanded="true" aria-controls="collapse_content">
                            Inhoud bestelling
                        </button>
                    </h5>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class='col-md-12'>
                            <div class="row basket_product">
                                ...
                                <div class="col-md-5">
                                    <h6><?php print($data['Description']); ?>
                                    </h6>
                                    <p><?php print(!empty($data['Size']) ? "Grootte: " . $data['Size']: "Geen grootte"); ?>
                                    </p>
                                    <p><?php print('Aantal: ' . $data['Quantity']) ?>
                                    </p>
                                </div>
                                <div class="col-md-4">
                                    <?php
