    ...
    */
    ...
    if ($row['InternalComments'] == "paid") {
        ...
        $message = $message."
            ...
            Om de betaling opnieuw te starten drukt u <a href='http://worldwideimporters.shop/f_handler.php?form_handler=f_restart_payment.php&orderId=".$order_id."&payment=open'>hier</a>.
            <br /><br />";
